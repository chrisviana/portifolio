    ...
    <div className="sm:flex items-center mt-36">
      <div>
        ...
        <p className="text-[#232E35]">
          ...
          Developer since 2017 where I had my first experience utilizing COS (Caché Object Script) and CSP (Caché Server Pages) acting directly as Full Stack. Today I work directly as Front End, but I always apply my studies in back-end and front-end technologies
        </p>
